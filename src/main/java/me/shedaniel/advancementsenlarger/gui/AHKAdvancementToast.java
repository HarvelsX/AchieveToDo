...
public class AHKAdvancementToast implements Toast {
    Identifier TEXTURE = new Identifier("ahk", "textures/gui/ahk_toasts2.png");

    private final Advancement advancement;
    public final BlockedAction blockedAction;
    private boolean soundPlayed;

    public AHKAdvancementToast(Advancement advancement, BlockedAction blockedAction) {
