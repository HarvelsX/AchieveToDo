...
public enum BlockedAction {
    ...
    FOOD_BLOCK_LEVEL_4("food block", 100),
    ...
    FOOD_BLOCK_LEVEL_3("food block", 250),
    ...
    FOOD_BLOCK_LEVEL_2("food block", 500),
    ...
    END("Край закрыт", 725),
    FOOD_BLOCK_LEVEL_1("food block", 750),
    ...
    FOOD_BLOCK_LEVEL_0("food block", 875),
